...
MODULE FINITE_ELASTICITY_ROUTINES
  ...
  PUBLIC FiniteElasticityEquationsSet_DerivedVariableCalculate, &
    & FiniteElasticity_StrainInterpolateXi,FiniteElasticity_DeformationGradInterpolateXi
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      IF(ASSOCIATED(EQUATIONS)) THEN 
        ...
        IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_STATIC_INRIA_SUBTYPE .OR. &
          ...
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_POWER_SUBTYPE .OR. &
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_MR_SUBTYPE .OR. &
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_ANISO_MR_SUBTYPE .OR. &
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_PZ_SUBTYPE .OR. &
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_SUBTYPE .OR. &
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_ORTHO_SUBTYPE .OR. &
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_HM_ORTHO_SUBTYPE .OR. &
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_HOLZAPFEL_SUBTYPE .OR. &
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_GUCCIONE_SUBTYPE .OR. &
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_SQ_ORTHO_SUBTYPE .OR. &
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_MR_M_SUBTYPE .OR. &
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_M_SUBTYPE .OR. &
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_POWER_M_SUBTYPE .OR. &
          & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_COOKSON_SUBTYPE) THEN
          DARCY_DENSITY=.TRUE.
        ELSE
          DARCY_DENSITY=.FALSE.
        ENDIF
        ...
        CASE(EQUATIONS_SET_NO_SUBTYPE,EQUATIONS_SET_MEMBRANE_SUBTYPE, EQUATIONS_SET_MOONEY_RIVLIN_SUBTYPE, &
          ...
          & EQUATIONS_SET_POWER_VOLUME_CONSTRAINED_SUBTYPE,EQUATIONS_SET_ELASTICITY_HOLMES_MOW_SUBTYPE, &
          & EQUATIONS_SET_ELASTICITY_EXP_SQUARED_SUBTYPE)
          ...
          DO gauss_idx=1,DEPENDENT_NUMBER_OF_GAUSS_POINTS
            ...
            ELSE IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_POWER_VOLUME_CONSTRAINED_SUBTYPE) THEN
              DARCY_VOL_INCREASE = MATERIALS_INTERPOLATED_POINT%VALUES(4,NO_PART_DERIV)-1.0_DP
            ENDIF
              ...
              IF(DEPENDENT_COMPONENT_INTERPOLATION_TYPE==FIELD_NODE_BASED_INTERPOLATION) THEN !node based
                ...
                DO parameter_idx=1,NUMBER_OF_FIELD_COMPONENT_INTERPOLATION_PARAMETERS
                  ...
                  IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_INCOMPRESSIBLE_ELASTICITY_DRIVEN_DARCY_SUBTYPE .OR. &
                      & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_POWER_VOLUME_CONSTRAINED_SUBTYPE) THEN
                    NONLINEAR_MATRICES%ELEMENT_RESIDUAL%VECTOR(element_dof_idx)= &
                      & NONLINEAR_MATRICES%ELEMENT_RESIDUAL%VECTOR(element_dof_idx)+ &
        ...
        CASE (EQUATIONS_SET_COMPRESSIBLE_FINITE_ELASTICITY_SUBTYPE,EQUATIONS_SET_ELASTICITY_DARCY_INRIA_MODEL_SUBTYPE, &
            ...
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_POWER_SUBTYPE, &
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_MR_SUBTYPE, &
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_ANISO_MR_SUBTYPE, &
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_PZ_SUBTYPE , &
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_SUBTYPE, &
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_ORTHO_SUBTYPE, &
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_HM_ORTHO_SUBTYPE, &
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_HOLZAPFEL_SUBTYPE, &
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_GUCCIONE_SUBTYPE, &
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_SQ_ORTHO_SUBTYPE, &
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_MR_M_SUBTYPE, &
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_M_SUBTYPE, &
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_POWER_M_SUBTYPE, &
            & EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_COOKSON_SUBTYPE)
  ...
  SUBROUTINE FINITE_ELASTICITY_FINITE_ELEMENT_PRE_RESIDUAL_EVALUATE(EQUATIONS_SET,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      CASE(EQUATIONS_SET_MEMBRANE_SUBTYPE,EQUATIONS_SET_MOONEY_RIVLIN_SUBTYPE,EQUATIONS_SET_ISOTROPIC_EXPONENTIAL_SUBTYPE, &
          ...
          & EQUATIONS_SET_POWER_VOLUME_CONSTRAINED_SUBTYPE, &
          & EQUATIONS_SET_ELASTICITY_HOLMES_MOW_SUBTYPE, &
          & EQUATIONS_SET_ELASTICITY_EXP_SQUARED_SUBTYPE)
        !Do nothing ???
      CASE DEFAULT
...
999 CALL ERRORS("FiniteElasticityEquationsSet_DerivedVariableCalculate",err,error)
  ...
  SUBROUTINE FiniteElasticity_StrainCalculate(equationsSet,strainField,strainFieldVariableType,err,error,*)
    ...
    REAL(SP) :: ELEMENT_USER_ELAPSED,ELEMENT_SYSTEM_ELAPSED,USER_ELAPSED,USER_TIME2(1),USER_TIME3(1),USER_TIME4(1), &
      & SYSTEM_ELAPSED,SYSTEM_TIME2(1),SYSTEM_TIME3(1),SYSTEM_TIME4(1)
    ...
    IF(ASSOCIATED(equationsSet)) THEN
      ...
      IF(ASSOCIATED(EQUATIONS)) THEN 
        ...
        !Transfer values to/from ghost elements
...
999 CALL ERRORS("FiniteElasticity_StrainCalculate",err,error)
  ...
  SUBROUTINE FiniteElasticity_StrainInterpolateXi(equationsSet,userElementNumber,xi,values,err,error,*)
    ...
    CALL FINITE_ELASTICITY_GAUSS_DEFORMATION_GRADIENT_TENSOR(dependentInterpolatedPoint, &
      & geometricInterpolatedPoint,fibreInterpolatedPoint,numberOfDimensions, &
      & numberOfXi,DZDNU,Jxxi,err,error,*999)
...
999 CALL Errors("FiniteElasticity_StrainInterpolateXi",err,error)
  ...
  SUBROUTINE FiniteElasticity_DeformationGradInterpolateXi(equationsSet,userElementNumber,xi,values,err,error,*)
    ! Argument variables
    TYPE(EQUATIONS_SET_TYPE), POINTER, INTENT(IN) :: equationsSet !<A pointer to the equations set to calculate strain for
    INTEGER(INTG), INTENT(IN) :: userElementNumber
    REAL(DP), INTENT(IN) :: xi(:)
    ...
    INTEGER(INTG) :: dependentVarType,meshComponentNumber
    INTEGER(INTG) :: numberOfDimensions,numberOfXi
    INTEGER(INTG) :: localElementNumber,i,j
    REAL(DP) :: DZDNU(3,3),DZDNUT(3,3),Jxxi

    CALL Enters("FiniteElasticity_DeformationGradInterpolateXi",err,error,*999)
    ...
    !Set output F components
    DO i=1,3
      DO j=1,3
        values(3*(i-1)+j) = DZDNU(i,j)
      END DO
    END DO

    CALL Exits("FiniteElasticity_DeformationGradInterpolateXi")
    RETURN

999 CALL Errors("FiniteElasticity_DeformationGradInterpolateXi",err,error)
    CALL Exits("FiniteElasticity_DeformationGradInterpolateXi")
    RETURN 1
  END SUBROUTINE FiniteElasticity_DeformationGradInterpolateXi
...
999 CALL ERRORS("FINITE_ELASTICITY_GAUSS_DEFORMATION_GRADIENT_TENSOR",ERR,ERROR)
  ...
  SUBROUTINE FINITE_ELASTICITY_GAUSS_CAUCHY_TENSOR(EQUATIONS_SET,DEPENDENT_INTERPOLATED_POINT, &
    ...
    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_STATIC_INRIA_SUBTYPE)
      ...
      PIOLA_TENSOR=PIOLA_TENSOR+2.0_DP*C(2)*Jznu**(-4.0_DP/3.0_DP)*(I1*IDENTITY-AZL-(2.0_DP/3.0_DP)*I2*AZU)
    ...
    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_HOLMES_MOW_SUBTYPE)
      ...
      TEMPTERM=2.0_DP*C(1)*EXP(C(2)*(I1 - 3.0_DP) + C(3)*(I2 - 3.0_DP)) / (I3**(C(2)+2.0_DP*C(3)))
      PIOLA_TENSOR=C(2)*TEMPTERM*IDENTITY + C(3)*TEMPTERM*(I1*IDENTITY-AZL) - (C(2)+2.0_DP*C(3))*TEMPTERM*AZU &
        & + C(4)*(Jznu - 1.0_DP)*AZU &
        & - DARCY_DEPENDENT_INTERPOLATED_POINT%VALUES(1,NO_PART_DERIV)*Jznu*AZU

    CASE(EQUATIONS_SET_ELASTICITY_HOLMES_MOW_SUBTYPE)
      ! A pure finite elasticity version of Holmes and Mow's relation for poroelasticity
      I1=AZL(1,1)+AZL(2,2)+AZL(3,3)
      TEMP=MATMUL(AZL,AZL)
      I2=0.5_DP*(I1**2.0_DP-TEMP(1,1)-TEMP(2,2)-TEMP(3,3))
    ...
    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_HM_ORTHO_SUBTYPE)
      ! An isotropic exponential relationship based on Holmes and Mow's poroelastic relation,
      ! with anisotropic coupling to fluid pressure:
      ! c1 = C(1)
      ! c2 = C(2)
      ! c3 = C(3)
      ! K = C(4)
      ! B(11, 12, 13, 22, 23, 33) = C(5 to 10)
      B(1,:) = [C(5), C(6), C(7)]
      B(2,:) = [C(6), C(8), C(9)]
      B(3,:) = [C(7), C(9), C(10)]
      I1=AZL(1,1)+AZL(2,2)+AZL(3,3)
      ...
      PIOLA_TENSOR=C(2)*TEMPTERM*IDENTITY + C(3)*TEMPTERM*(I1*IDENTITY-AZL) - (C(2)+2.0_DP*C(3))*TEMPTERM*AZU &
        & + C(4)*(Jznu - 1.0_DP)*AZU &
        & - DARCY_DEPENDENT_INTERPOLATED_POINT%VALUES(1,NO_PART_DERIV)*Jznu*DZDNUI*B*DZDNUIT
    ...
    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_HOLZAPFEL_SUBTYPE)
      ...
      CASE(10)
        ! K(J - 1)^2
        PIOLA_TENSOR=PIOLA_TENSOR+C(9)*2.0_DP*(Jznu - 1.0_DP)*Jznu*AZU
      CASE(14)
    ...
    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_ANISO_MR_SUBTYPE)
      ...
      I1=AZL(1,1) + AZL(2,2) + AZL(3,3)
      PIOLA_TENSOR=2.0_DP*(C(1)*IDENTITY + C(2)*(I1*IDENTITY - AZL))

      !Add bulk-modulus term
      PIOLA_TENSOR=PIOLA_TENSOR+C(3)*(Jznu - 1.0_DP)*AZU

      !Account for non-zero hydrostatic pressure offset:
      p0=2.0_DP*C(1)+4.0_DP*C(2)
      PIOLA_TENSOR=PIOLA_TENSOR-p0*Jznu*AZU
    ...
    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_GUCCIONE_SUBTYPE)
      ...
      CASE(5)
        ! Standard guccione: W = c1/2 (e^Q - 1)
        !   Q = 2c2(E11+E22+E33) + c3(E11^2) + c4(E22^2+E33^2+E23^2+E32^2) + c5(E12^2+E21^2+E31^2+E13^2)
        ! Separated Guccione with extra c1 type parameters:
        ! W_hyp = c1/2 (e^(2c2(E11+E22+E33)) - 1)
        !       + c6/2 (e^(c3 E11^2) - 1)
        !       + c7/2 (e^(c4 E22^2) - 1)
        !       + c7/2 (e^(c4 E33^2) - 1)
        !       + c7/2 (e^(c4 (E23^2 + E32^2)) - 1)
        !       + c8/2 (e^(c5 (E12^2 + E21^2)) - 1)
        !       + c8/2 (e^(c5 (E13^2 + E31^2)) - 1)
        ! c6,c7,c8 = C(15)..C(17)
        ! Add (c1/2)*(e^2b1(E11+E22+E33)-1) based terms
        PIOLA_TENSOR=C(1)*C(2)*EXP(2.0_DP*C(2)*(E(1,1)+E(2,2)+E(3,3)))*IDENTITY
        ! Add E11, E22, E33 terms
        PIOLA_TENSOR(1,1)=PIOLA_TENSOR(1,1)+C(15)*C(3)*E(1,1)*EXP(C(3)*E(1,1)**2)
        PIOLA_TENSOR(2,2)=PIOLA_TENSOR(2,2)+C(16)*C(4)*E(2,2)*EXP(C(4)*E(2,2)**2)
        PIOLA_TENSOR(3,3)=PIOLA_TENSOR(3,3)+C(16)*C(4)*E(3,3)*EXP(C(4)*E(3,3)**2)
        ! Add E23 terms
        TEMPTERM=C(16)*C(4)*EXP(C(4)*(E(2,3)**2+E(3,2)**2))
        PIOLA_TENSOR(2,3)=PIOLA_TENSOR(2,3)+E(2,3)*TEMPTERM
        PIOLA_TENSOR(3,2)=PIOLA_TENSOR(3,2)+E(3,2)*TEMPTERM
        ! Add E12, E13 terms
        TEMPTERM=C(17)*C(5)*EXP(C(5)*(E(1,2)**2+E(2,1)**2))
        PIOLA_TENSOR(1,2)=PIOLA_TENSOR(1,2)+E(1,2)*TEMPTERM
        PIOLA_TENSOR(2,1)=PIOLA_TENSOR(2,1)+E(2,1)*TEMPTERM
        TEMPTERM=C(17)*C(5)*EXP(C(5)*(E(1,3)**2+E(3,1)**2))
        PIOLA_TENSOR(1,3)=PIOLA_TENSOR(1,3)+E(1,3)*TEMPTERM
        PIOLA_TENSOR(3,1)=PIOLA_TENSOR(3,1)+E(3,1)*TEMPTERM
      ...
      IF(ABS(C(7)-26.0_DP)<1.0E-6) THEN
        CR_SUBTYPE=26
      ELSE IF(ABS(C(7)-10.0_DP)<1.0E-6) THEN
        CR_SUBTYPE=10
      ...
      ELSE IF(ABS(C(7)-96.0_DP)<1.0E-6) THEN
        CR_SUBTYPE=96
      ELSE IF(ABS(C(7)-100.0_DP)<1.0E-6) THEN
        CR_SUBTYPE=100
      ELSE IF(ABS(C(7)-102.0_DP)<1.0E-6) THEN
        CR_SUBTYPE=102
      ELSE IF(ABS(C(7)-103.0_DP)<1.0E-6) THEN
        CR_SUBTYPE=103
      ELSE
        CR_SUBTYPE=1
      END IF
      ...
      CASE(10)
        ! K(J - 1)^2
        PIOLA_TENSOR=PIOLA_TENSOR+C(6)*2.0_DP*(Jznu - 1.0_DP)*Jznu*AZU
      CASE(26)
      ...
      CASE(87)
        ...
        DO i=1,3
          ...
          END DO
          !TEMP=g*dfdC + f*dgdC
          TEMP=(Jznu-1.0_DP)*TEMP+(AZL(1,1)*AZL(2,2)*AZL(3,3)/AZL(i,i))*0.5_DP*Jznu*AZU
          !PK2 = dPsi/dE = dC/dE * (2.0 * b * (f * g) * (g*df/dC + f*dg/dC))
          PIOLA_TENSOR=PIOLA_TENSOR+2.0_DP*TEMPTERM*TEMP
        END DO
      CASE(90)
      ...
      CASE(96)
        ...
        END DO
      CASE(100)
        ! Psi^bulk = ((K + b1 C22 C33 + b2 C11 C33 + b3 C11 C22) (J - 1))^2
        ! Psi^bulk = (f (J - 1))^2
        ! tempterm = f
        ! TEMP = df/dC
        TEMPTERM=C(6)
        ...
        DO i=1,3
          ...
          DO k=j+1,3
            IF(k/=i) EXIT
          END DO
          TEMPTERM=TEMPTERM+B(i,i)*AZL(j,j)*AZL(k,k)
          TEMP(i,i)=B(j,j)*AZL(k,k)+B(k,k)*AZL(j,j)
        END DO
        PIOLA_TENSOR=PIOLA_TENSOR+4.0_DP*TEMPTERM*(Jznu-1.0_DP)*(TEMPTERM*0.5_DP*Jznu*AZU+TEMP*(Jznu-1.0_DP))
      CASE(102)
        ! Psi^bulk = Iso J squared term + case 87
        ! (J - 1)^2:
        PIOLA_TENSOR=PIOLA_TENSOR+2.0_DP*C(6)*(Jznu - 1.0_DP)*Jznu*AZU
        ! Case 87:
        ! Psi^bulk = b1 ((C22*C33)*(J - 1))^2 + b2 ((C11*C33)*(J - 1))^2 + b3 ((C11*C22)*(J - 1))^2
        ! case87 in Python tests
        !
        ...
        END DO
      CASE(103)
        ! Psi^bulk = ((K + b1 C11 + b2 C22 + b3 C33) (J - 1))^2
        ! Psi^bulk = (f * (J - 1))^2
        ! tempterm = f, temp = dfdC
        TEMPTERM=C(6)
        TEMP=0.0_DP
        DO i=1,3
          TEMPTERM=TEMPTERM+B(i,i)*AZL(i,i)
          TEMP(i,i)=B(i,i)
        END DO
        ! dPsi/dE = 2.0 * dPsi/dC = 2.0 * (2.0 * f * (J - 1) * (dfdC * (J - 1) + f * dJdC))
        PIOLA_TENSOR=PIOLA_TENSOR+4.0_DP*TEMPTERM*(Jznu-1.0_DP)*((Jznu-1.0_DP)*TEMP+TEMPTERM*0.5_DP*Jznu*AZU)
      END SELECT
    ...
    CASE(EQUATIONS_SET_ELASTICITY_EXP_SQUARED_SUBTYPE)
      ...
      PIOLA_TENSOR=C(1)*(I1-3.0_DP)*EXP(C(2)*(I1-3.0_DP)**2.0_DP)*IDENTITY &
        & + 2.0_DP*P*AZU
      WRITE(*,*) AZL
      WRITE(*,*) P
      WRITE(*,*) PIOLA_TENSOR
    ...
    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_POWER_M_SUBTYPE)
      ! An isotropic power-law based relationship:
      ! W = c0 (J1 - 3) + (c1/k) (J1 - 3)^k + K (J - 1) - K ln(J)
      !
      ! c0 = C(1)
      ! c1 = C(2)
      ! k = C(3)
      ...
      ! phi^s_0 = C(5)
      I1=AZL(1,1)+AZL(2,2)+AZL(3,3)
      J1=I1*Jznu**(-2.0_DP/3.0_DP)
      p0=0.0_DP

      IF(ABS(C(3)-1.0_DP) < 1.0e-9) THEN
        TEMPTERM=1.0_DP
        p0=p0+2.0_DP*C(2)
      ELSE IF(J1<3.0_DP) THEN
        TEMPTERM=-C(3)*(3.0_DP-J1)**(C(3)-1.0_DP)
      ELSE
        TEMPTERM=C(3)*(J1-3.0_DP)**(C(3)-1.0_DP)
      END IF

      !dJ1/dC:
      TEMP=Jznu**(-2.0_DP/3.0_DP)*(IDENTITY-(1.0_DP/3.0_DP)*I1*AZU)

      PIOLA_TENSOR=2.0_DP*C(5)*( &
        & C(1)*TEMP + &
        & (C(2)/C(3))*TEMPTERM*TEMP) + &
        & C(4)*(Jznu - 1.0_DP)*AZU - &
        & (DARCY_DEPENDENT_INTERPOLATED_POINT%VALUES(1,NO_PART_DERIV)+p0)*Jznu*AZU

    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_MR_SUBTYPE)
      ! An isotropic Mooney-Rivlin based relationship:
      ! W = c1 (I1 - 3) + c2 (I2 - 3) + K (J - 1) - K ln(J)
      ! c1 = C(1)
      ! c2 = C(2)
      ! K = C(3)
      p0=2.0_DP*C(1) + 4.0_DP*C(2)
    ...
    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_MR_M_SUBTYPE)
      ! An isotropic Mooney-Rivlin based relationship using the first modified invariant of C:
      ! W = c1 (J1 - 3) + c2 (J2 - 3) + K (J - 1) - K ln(J)
      ! c1 = C(1)
      ! c2 = C(2)
      ! K = C(3)
      p0=0.0_DP
      ...
      I2=0.5_DP*(I1**2.0_DP-(TEMP(1,1)+TEMP(2,2)+TEMP(3,3)))
      PIOLA_TENSOR=2.0_DP*(C(1)*Jznu**(-2.0_DP/3.0_DP)*(IDENTITY-(1.0_DP/3.0_DP)*I1*AZU) &
        & + C(2)*Jznu**(-4.0_DP/3.0_DP)*(I1*IDENTITY - AZL - (2.0_DP/3.0_DP)*I2*AZU)) &
        & + C(3)*(Jznu - 1.0_DP)*AZU &
        & - (DARCY_DEPENDENT_INTERPOLATED_POINT%VALUES(1,NO_PART_DERIV)+p0)*Jznu*AZU

    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_SUBTYPE)
      ! An isotropic exponential based relationship:
      ! W = (c1 / c2) [exp(c2 (I1 - 3)) - 1] + K (J - 1) - K ln(J)
      ! c1 = C(1)
      ! c2 = C(2)
      ! K = C(3)
      p0 = 2.0_DP * C(1)
    ...
    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_M_SUBTYPE)
      ! An isotropic exponential based relationship using the first modified invariant of C:
      ! W = (c1 / c2) [exp(c2 (J1 - 3)) - 1] + K (J - 1) - K ln(J)
      ! where J1, aka \bar{I}_1, is the first modified invariant
      ! c1 = C(1)
      ! c2 = C(2)
      ! K = C(3)
      p0 = 0.0_DP
      ...
      PIOLA_TENSOR=2.0_DP*(C(1)*EXP(C(2)*(I1*Jznu**(-2.0_DP/3.0_DP)-3.0_DP))* &
        & Jznu**(-2.0_DP/3.0_DP)*(IDENTITY-(1.0_DP/3.0_DP)*I1*AZU)) &
        & + C(3)*(Jznu - 1.0_DP)*AZU &
        & - (DARCY_DEPENDENT_INTERPOLATED_POINT%VALUES(1,NO_PART_DERIV)+p0)*Jznu*AZU

    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_COOKSON_SUBTYPE)
      ! An isotropic exponential relationship from:
      ! Cookson, A. N., Lee, J., Michler, C., Chabiniok, R., Hyde, E., Nordsletten, D. A., Sinclair, M., et al. (2012). A novel
      ! porous mechanical framework for modelling the interaction between coronary perfusion and myocardial mechanics. J Biomech,
      ! 45(5), 850–855. doi:10.1016/j.jbiomech.2011.11.026
      !
      ! a = C(1)
      ! D1 = C(2)
      ! D2 = C(3)
      ...
      I2=0.5_DP*(I1**2.0_DP-(TEMP(1,1)+TEMP(2,2)+TEMP(3,3)))
      J1=I1*Jznu**(-2.0_DP/3.0_DP)
      J2=I2*Jznu**(-4.0_DP/3.0_DP)
      added_fluid_vol=(Jznu-1.0_DP)

      TEMPTERM=C(2)*(J1*(1.0_DP + C(5)*added_fluid_vol) - 3.0_DP) +&
        & C(3)*(J2*(1.0_DP + C(6)*added_fluid_vol) - 3.0_DP) + &
        & C(4)*((Jznu-1.0_DP)**2 + C(7)*added_fluid_vol**2)

      PIOLA_TENSOR=C(1)*EXP(TEMPTERM)*(C(2)*(1.0+C(5)*added_fluid_vol)*Jznu**(-2.0_DP/3.0_DP)*(IDENTITY-(1.0_DP/3.0_DP)*I1*AZU) &
        & + C(3)*(1.0+C(6)*added_fluid_vol)*Jznu**(-4.0_DP/3.0_DP)*(I1*IDENTITY-AZL-(2.0_DP/3.0_DP)*I2*AZU) &
        & + C(4)*(Jznu-1.0_DP)*Jznu*AZU) &
        & - DARCY_DEPENDENT_INTERPOLATED_POINT%VALUES(1,NO_PART_DERIV)*Jznu*AZU

    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_PZ_SUBTYPE)
      ! An isotropic relationship based on the pole-zero relation:
      ! W = k (I1 - 3)^2 * (a + 3 - I1)^-b + K (J - 1) - K ln(J)
      ! k = C(1)
      ! a = C(2)
      ! b = C(3)
      ! K = C(4)
      ...
      PIOLA_TENSOR= &
        & 2.0_DP*( &
          & 2.0_DP*C(1)*(I1-3.0_DP)*(C(2)+3.0_DP-I1)**(-C(3)) + &
          & C(1)*C(3)*((I1-3.0_DP)**2)*((C(2)+3.0_DP-I1)**(-C(3)-1.0_DP)) &
        & )*IDENTITY &
        & + C(4)*(Jznu - 1.0_DP)*AZU &
        & - (DARCY_DEPENDENT_INTERPOLATED_POINT%VALUES(1,NO_PART_DERIV)+p0)*Jznu*AZU

    CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_ORTHO_SUBTYPE)
      ! An isotropic exponential based relationship, with anisotropic coupling
      ! to fluid pressure:
      ! W^s = (1 - phi_0) (c1 / c2) [exp(c2 (I1 - 3)) - 1] + K (J - 1) - K ln(J)
      ! W^f = ?
      ! S = dW^s/dE - phi_f p J C^-T - phi_s p B
      ! c1 = C(1)
      ! c2 = C(2)
      ! K = C(3)
      ! phi_0 = C(4)
      ! B(11, 12, 13, 22, 23, 33) = C(5 to 10)
      ! B is inverse of fabric tensor, giving orientations of vessel walls
      B(1,:) = [C(5), C(6), C(7)]
      B(2,:) = [C(6), C(8), C(9)]
      B(3,:) = [C(7), C(9), C(10)]
    ...
    CASE(EQUATIONS_SET_POWER_VOLUME_CONSTRAINED_SUBTYPE)
      ...
      ! c1 = C(2)
      ! k = C(3)
      ! J = C(4), this is used in the residual calculation to set the DARCY_VOL_INCREASE
      I1=AZL(1,1)+AZL(2,2)+AZL(3,3)
      IF(ABS(C(3)-1.0_DP) < 1.0e-9) THEN
        TEMPTERM=1.0_DP
      ELSE IF(I1<3.0_DP) THEN
...
999 CALL ERRORS("FINITE_ELASTICITY_GAUSS_DFDZ",ERR,ERROR)
  ...
  SUBROUTINE FINITE_ELASTICITY_EQUATIONS_SET_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    IS_HYDROSTATIC_PRESSURE_DEPENDENT_FIELD = EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_COMPRESSIBLE_FINITE_ELASTICITY_SUBTYPE &
                            ...
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_POWER_SUBTYPE &
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_MR_SUBTYPE &
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_ANISO_MR_SUBTYPE &
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_PZ_SUBTYPE  &
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_SUBTYPE &
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_ORTHO_SUBTYPE &
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_HM_ORTHO_SUBTYPE &
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_HOLZAPFEL_SUBTYPE &
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_GUCCIONE_SUBTYPE &
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_SQ_ORTHO_SUBTYPE &
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_MR_M_SUBTYPE &
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_M_SUBTYPE &
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_POWER_M_SUBTYPE &
                            & .AND. EQUATIONS_SET%SUBTYPE/=EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_COOKSON_SUBTYPE
          ...
          CASE(EQUATIONS_SET_SETUP_START_ACTION)
            ...
            IF(ASSOCIATED(EQUATIONS_MATERIALS)) THEN
              ...
              CASE(EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_COOKSON_SUBTYPE)
                ...
                NUMBER_OF_FLUID_COMPONENTS=8
              CASE(EQUATIONS_SET_POWER_VOLUME_CONSTRAINED_SUBTYPE)
                NUMBER_OF_COMPONENTS = 4  ! No K and phi_s but added J param
                !No fluid equations, we don't solve for pressure
              CASE(EQUATIONS_SET_CONSTITUTIVE_LAW_IN_CELLML_EVALUATE_SUBTYPE)
                NUMBER_OF_COMPONENTS = 2;
              CASE(EQUATIONS_SET_ELASTICITY_HOLMES_MOW_SUBTYPE)
                NUMBER_OF_COMPONENTS = 3;
