...
MODULE EQUATIONS_SET_CONSTANTS
 ...
 !Bioelectrics class
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_POWER_SUBTYPE=21
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_POWER_VOLUME_CONSTRAINED_SUBTYPE=22
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_COOKSON_SUBTYPE=23
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_MR_SUBTYPE=24
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_SUBTYPE=25
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_PZ_SUBTYPE =26
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_MR_M_SUBTYPE=27
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_M_SUBTYPE=28
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_POWER_M_SUBTYPE=29
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_ORTHO_SUBTYPE=30
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_HOLMES_MOW_SUBTYPE=31
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_HM_ORTHO_SUBTYPE=32
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_EXP_SQUARED_SUBTYPE=33
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_EXP_SQ_ORTHO_SUBTYPE=34
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_HOLZAPFEL_SUBTYPE=35
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_GUCCIONE_SUBTYPE=36
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTICITY_FLUID_PRESSURE_ANISO_MR_SUBTYPE=37
  !Fluid mechanics class
  !  Stokes equations
